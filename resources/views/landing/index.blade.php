    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-5 mb-lg-0 pe-lg-5">
                <span class="badge-primary-light d-inline-flex align-items-center gap-2 mb-3">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="{{ route('login') }}" class="btn btn-primary px-5 py-3 rounded-3 fw-semibold shadow-sm">Login</a>
                    <a href="#" class="btn btn-outline-primary px-4 py-3 rounded-3 fw-semibold d-flex align-items-center gap-2">
            ...
            <div class="col-lg-6">
                <div class="hero-images-container d-flex justify-content-center align-items-center">
                    <img src="{{ asset('assets/img/heroimg.png') }}" alt="Hero Image" class="img-fluid" style="width: 100%; max-width: 650px; object-fit: contain; transform: scale(1.1);">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-5 mb-lg-0 pe-lg-5">
                <div class="about-img-container">
                    <img src="https://images.unsplash.com/photo-1564013799919-ab600027ffc6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Tentang Kami" class="about-img">
                    <div class="floating-badge">
                        ...
                        <div>
                            <div class="text-muted" style="font-size: 11px; font-weight: 600; letter-spacing: 0.5px;">Tagihan Bulan Ini</div>
                            <div class="fw-bold text-dark" style="font-size: 15px;">Lunas</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="cta-section">
            <div class="row align-items-center g-0 h-100">
                ...
                <div class="col-lg-6 cta-image-wrapper">
